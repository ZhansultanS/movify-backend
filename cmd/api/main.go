...
func main() {
	...
	flag.BoolVar(&cfg.rateLimiter.enabled, "limiter-enabled", false, "Enable rate limiter")
	...
	cfg.cors.trustedOrigins = append(cfg.cors.trustedOrigins, "http://localhost:4200")
